...
<head>
	<meta charset="UTF-8">
	<title>管理员管理学生</title>
	<link rel="stylesheet" href="/ElectiveSystem/public/css/manager_stulist.css" />
...
<body class="all">
	...
	<table cellspacing="0" class="table">
		...
		<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
			...
			<form method="post" action="<?php echo U('/Home/Manager/stuedit_do');?>">
				<td class="td2">
            ...
            <td class="td2"><a href="<?php echo U("/Home/Manager/deleteStudent/StuNo/$vo[stuno]");?>" onclick="return confirm('确定删除?')">删除</a></td>
